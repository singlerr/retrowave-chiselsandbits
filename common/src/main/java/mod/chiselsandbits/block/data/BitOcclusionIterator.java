...
public class BitOcclusionIterator extends BitCollisionIterator {
    ...
    public BitOcclusionIterator(final List<AABB> out) {
        o = out;
    }
    ...
    private boolean isNextTo(final AABB newBox, final AABB lastBox) {
    ...
    private boolean isBelow(final AABB newBox, final AABB lastBox) {
        final boolean sameX = newBox.minX == lastBox.minX && newBox.maxX == lastBox.maxX;
