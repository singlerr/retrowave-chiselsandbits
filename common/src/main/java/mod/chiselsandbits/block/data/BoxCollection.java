...
public class BoxCollection implements Collection<AxisAlignedBB> {
    ...
    static class BoxIterator implements Iterator<AxisAlignedBB> {
        ...
        public BoxIterator(final AxisAlignedBB[][] a) {
            arrays = a;
            findNextItem();
        }
    ...
    public BoxCollection(final AxisAlignedBB[] a) {
        arrays = new AxisAlignedBB[1][];
        arrays[0] = a;
    }

    public BoxCollection(final AxisAlignedBB[] a, final AxisAlignedBB[] b) {
        arrays = new AxisAlignedBB[2][];
        arrays[0] = a;
        arrays[1] = b;
    }

    public BoxCollection(final AxisAlignedBB[] a, final AxisAlignedBB[] b, final AxisAlignedBB[] c) {
    ...
    @Override
    public boolean add(final AxisAlignedBB e) {
        throw new UnsupportedOperationException();
    }

    @Override
    public boolean addAll(final Collection<? extends AxisAlignedBB> c) {
        throw new UnsupportedOperationException();
    }
