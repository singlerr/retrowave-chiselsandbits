...
public class BitLocation implements IBitLocation {
    ...
    public BitLocation(final BlockRayTraceResult mop, final BitOperation type) {
        final Vector3d hitVec = mop.getHitVec();
        final Vector3d accuratePos = new Vector3d(
                mop.getPos().getX(), mop.getPos().getY(), mop.getPos().getZ());
        ...
        final Vector3i inBlockPos = new Vector3i(
                (int) inBlockPosAccurate.getX(), (int) inBlockPosAccurate.getY(), (int) inBlockPosAccurate.getZ());
        ...
        final Vector3i normalizedInBlockPosWithOffset =
                type.usePlacementOffset() ? normalizedInBlockPos.offset(mop.getFace(), 1) : normalizedInBlockPos;
