...
public enum ModConflictContext implements IKeyConflictContext {
    ...
    HOLDING_TAPEMEASURE {
        ...
        public boolean isActive() {
            return super.isActive()
                    || ClientSide.instance.getHeldToolType(Hand.MAIN_HAND) == ChiselToolType.TAPEMEASURE;
        }
    ...
    HOLDING_POSTIVEPATTERN {
        ...
        public boolean isActive() {
            return super.isActive()
                    || ClientSide.instance.getHeldToolType(Hand.MAIN_HAND) == ChiselToolType.POSITIVEPATTERN;
        }
